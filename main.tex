...
Mytkowicz \etal evaluate 4 profilers for Java. They found that they do not match in their evaluation to identify the hot methods, candidates to optimize. They then propose a more accurate profiler that collects samples randomly and it does not suffer from the above problems~\cite{Mytk10a}. 
