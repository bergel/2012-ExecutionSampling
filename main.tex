...
\figref{IterationEvolutionOnVW} the evolution of the ratio for 4 applications. We tried two industrial applications, noted \ct{X} and \ct{Y}, and two open-source applications, Mondrian and OSkStream. We profiled the two industrial applications on a Window XP machine and the two open-source applications on a Linux Ubuntu. 
