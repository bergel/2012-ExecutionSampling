...
We show that the relation between the number of iterations and the precision of the profile\del{r} \chg{follows a logarithm curve}{}. 
...
First, we need to get rid of the logarithm by writing $X = ln(x)$ and $Y = y$. The equation becomes $Y = a X + b$, which is much simpler to reason about. \chk {For a given set of (X, Y ) plots, a and b are easily determined using linear least squares fit:}
